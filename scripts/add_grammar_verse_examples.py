...
VERSE_EXAMPLES = {
    "begadkefat": [
        ("gen.1.1", "בְּרֵאשִׁית בָּרָא אֱלֹהִים",
         "In the beginning God created — both initial Bet forms contain dagesh and have /b/",
         "בְּרֵאשִׁית (bə-) — Bet with dagesh, hard B sound\nבָּרָא (bā-) — Bet with dagesh, hard B sound"),
    ...
    "numeral_agreement": [
        ("gen.40.12", "שְׁלֹשֶׁת הַשָּׂרִיגִים שְׁלֹשֶׁת יָמִים הֵם",
         "The three branches are three days — construct form of the masculine numeral",
         "שְׁלֹשֶׁת is the construct form of the masculine numeral used with the masculine plurals הַשָּׂרִיגִים and יָמִים"),
    ...
    "direct_object_marker": [
        ("gen.1.1", "אֵת הַשָּׁמַיִם וְאֵת הָאָרֶץ",
         "The heavens and the earth — את marks the direct object",
         "אֵת הַשָּׁמַיִם (et hashamayim) and אֵת הָאָרֶץ (et ha'aretz) — both are definite direct objects marked by את"),
        ("gen.1.27", "וַיִּבְרָא אֱלֹהִים אֶת־הָאָדָם",
         "God created the man — the man is the direct object",
         "אֶת־הָאָדָם (et ha'adam) = the man as direct object"),
    ],
    "adjective_agreement": [
        ("gen.1.31", "וְהִנֵּה טוֹב מְאֹד",
         "And behold it was very good — טוב (good) is predicate adjective",
         "טוֹב מְאֹד (tov me'od) = 'very good' — predicate adjective, no article needed"),
        ("num.14.7", "טוֹבָה הָאָרֶץ מְאֹד מְאֹד",
         "The land is very very good — feminine adjective with feminine subject",
         "טוֹבָה (tovah) is feminine to agree with הָאָרֶץ (the land, feminine)"),
    ],
    "nominal_clauses": [
        ("gen.1.2", "וְהָאָרֶץ הָיְתָה תֹהוּ וָבֹהוּ",
         "The earth was formless and void — was + predicate nominative",
         "וְהָאָרֶץ (subject) + הָיְתָה (was, feminine) + תֹהוּ וָבֹהוּ (predicate nominatives)"),
        ("exo.6.2", "אֲנִי יְהוָה",
         "I am YHWH — a nominal clause without an expressed copula",
         "אֲנִי (subject) + יְהוָה (predicate identification); no finite verb is present"),
        ("psa.24.1", "לַיהוָה הָאָרֶץ",
         "The earth is YHWH's — verbless possessive clause",
         "לַיהוָה (to YHWH = YHWH's) + הָאָרֶץ (the earth) = 'the earth belongs to YHWH'"),
    ],
    "waw_relative": [
