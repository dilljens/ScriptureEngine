/**
 * Mobile bottom navigation — now 7 tabs with Hebrew, Knowledge, Memory.
 */
...
const TABS = [
  ...
  { id: 'knowledge', label: 'Quiz', icon: '✍️' },
...
export default function MobileBottomNav({ activeTab, onTab }) {
  return (
    <nav className="fixed bottom-0 inset-x-0 z-50 sm:hidden bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700 safe-area-bottom">
