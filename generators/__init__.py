...
# ── Isaiah-Specific (scoped to book=isa) ──
    ...
    {
        "name": "Passage — Narrative Parallel",
        "module_path": ".passage.narrative_parallel",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "verses table (present), text_english column",
        "description": "Connects structurally parallel narrative passages (birth/annunciation, deliverance, covenant ratification, theophany, wilderness, judgment/restoration, calling) across books.",
        "tier": "idle",
        "cost": "free",
        "precision": 0.6,
        "avg_run_time_s": 40,
    ...
    {
        "name": "Passage — Macro-Chiasm",
        "module_path": ".passage.macro_chiasm",
        "layers": ["structural"],
        "automatic": True,
        "requires": "verses table (present), text_english column",
        "description": "Detects book-level mirrored (chiastic) section structure by comparing symmetric chapter signatures, emitting labeled macro_chiasm passage connections.",
        "tier": "idle",
        "cost": "free",
        "precision": 0.55,
        "avg_run_time_s": 60,
    ...
    {
        "name": "Passage — Covenant Structure",
        "module_path": ".passage.covenant_structure",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "verses table (present), text_english column",
        "description": "Matches curated covenant/treaty-form passages (Sinai, Deuteronomy, Joshua 24, Nehemiah, Jeremiah 31, Sermon on the Mount, Hebrews) by shared treaty elements.",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.7,
        "avg_run_time_s": 5,
    ...
    {
        "name": "Passage — Interpretation Network",
        "module_path": ".passage.interpretation_network",
        "layers": ["intertextual"],
        "automatic": True,
        "requires": "connections table (present), intertextual layer",
        "description": "Walks chains of quotation/allusion/echo edges (depth 3) and connects chain endpoints that are not directly connected, surfacing inner-biblical interpretation networks.",
        "tier": "periodic",
        "cost": "free",
        "precision": 0.55,
        "avg_run_time_s": 90,
    ...
    {
        "name": "Passage — Typology",
        "module_path": ".passage.typology",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "typology table (populated), passage_connections table",
        "description": "Lifts curated verse-level typology pairs into passage-level type/antitype arcs, plus narrative-level arcs (Exodus->salvation, temple->body, etc.).",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.7,
        "avg_run_time_s": 5,
    ...
    {
        "name": "Passage — Source Layers",
        "module_path": ".passage.source_layers",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "verses table (present)",
        "description": "Tags passages with critical source attributions (J/E/D/P, Deutero/Trito-Isaiah, Psalms books, Deuteronomistic History, apocalyptic) and connects same-source passages.",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.75,
        "avg_run_time_s": 5,
    ...
    {
        "name": "Passage — Multilingual Network",
        "module_path": ".passage.multilingual_network",
        "layers": ["textual"],
        "automatic": True,
        "requires": "text_resources table (populated, KJV/WEB/LSV)",
        "description": "Connects textual-crux passages where KJV/WEB/LSV translations diverge most. Documented gap: no LXX/Vulgate/Peshitta text yet, so this is translation-family divergence, not versional alignment.",
        "tier": "periodic",
        "cost": "free",
        "precision": 0.5,
        "avg_run_time_s": 60,
    ...
    {
        "name": "Passage — Social Setting",
        "module_path": ".passage.social_setting",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "verses table (present)",
        "description": "Tags passages by Sitz im Leben (patriarchal nomadic, temple cultic, exile, diaspora, synagogue, persecuted church) and connects same-setting passages.",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.55,
        "avg_run_time_s": 5,
    ...
    {
        "name": "Passage — Rhetorical",
        "module_path": ".passage.rhetorical",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "verses table (present)",
        "description": "Tags passages by rhetorical form (judgment oracle, lament, hymn, covenant lawsuit, wisdom instruction, farewell discourse) and connects same-rhetoric passages.",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.6,
        "avg_run_time_s": 5,
    ...
    {
        "name": "Passage — Reception History",
        "module_path": ".passage.reception_history",
        "layers": ["interpretive"],
        "automatic": True,
        "requires": "interpretive_disagreements table (populated)",
        "description": "Connects tradition-engaged passages (multiple interpretive traditions argue over them) through the reception network, folding scholar provenance into metadata.",
        "tier": "lightweight",
        "cost": "free",
        "precision": 0.5,
        "avg_run_time_s": 10,
