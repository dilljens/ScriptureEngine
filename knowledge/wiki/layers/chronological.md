...
> **Example**: The 70-weeks prophecy of Daniel 9 connects to the time of Jesus' ministry

## Purpose

The Chronological layer links events by time — same periods, genealogical connections, prophetic timeline fulfillments, sabbatical and jubilee cycles.

## Knowledge Assessment

There are **13,175** knowledge items in this layer.
...
|-------|-------|-------------|
| P'Shat | 11,062 | Remember |
| Remez | 1,879 | Understand |
| Drash | 234 | Analyze |

### Difficulty

Average difficulty: **0.47** (range: 0.30–0.60)
