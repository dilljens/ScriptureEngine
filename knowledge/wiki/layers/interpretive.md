...
> **Example**: The Suffering Servant in Isaiah 53 — Jewish tradition reads it as Israel, Christian tradition reads it as Jesus

## Purpose

The Interpretive layer tracks how different traditions have read the same texts — from rabbinic midrash and patristic exegesis to Gileadi's structural observations and Latter-day Saint readings.

## Knowledge Assessment

There are **6,997** knowledge items in this layer.
...
Average difficulty: **0.70** (range: 0.05–0.80)

---
## Understanding Connection Quality

The Scripture Knowledge Engine rates every connection on a **1–5 star scale**:
...
**PaRDeS** (פַּרְדֵּס, meaning "orchard/garden") is a four-level framework for scriptural interpretation:
...
**Bloom's Taxonomy** classifies learning objectives by cognitive depth:
...
**Difficulty** (0.0–1.0) measures how challenging a connection is to recognize and understand:
