...
> **Example**: Matthew 2:15 quotes Hosea 11:1 — 'Out of Egypt I called my son'

## Purpose

The Intertextual layer tracks how later texts quote, allude to, or echo earlier texts — from verbatim quotations to subtle linguistic echoes spanning centuries.

## Knowledge Assessment

There are **250,462** knowledge items in this layer.
...
|-------|-------|-------------|
| Remez | 250,297 | Understand |
| Drash | 165 | Analyze |

### Difficulty

Average difficulty: **0.48** (range: 0.05–0.70)
